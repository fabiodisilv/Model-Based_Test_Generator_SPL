...
public class GenericAdapterFactory extends AdapterFactoryImpl {
	...
	protected GenericSwitch<Adapter> modelSwitch =
		new GenericSwitch<Adapter>() {
			...
			@Override
			public Adapter caseGenericInput(GenericInput object) {
				return createGenericInputAdapter();
			}
			@Override
			public Adapter caseGenericOutput(GenericOutput object) {
				return createGenericOutputAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link generic.Family <em>Family</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link generic.GenericFunction <em>Function</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link generic.GenericStep <em>Step</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link generic.GenericInput <em>Input</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGenericInputAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link generic.GenericOutput <em>Output</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGenericOutputAdapter() {
		return null;
	}
