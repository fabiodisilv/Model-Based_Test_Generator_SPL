...
public class GenericSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GenericPackage.FAMILY: {
				Family family = (Family)theEObject;
				T result = caseFamily(family);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GenericPackage.GENERIC_FUNCTION: {
				GenericFunction genericFunction = (GenericFunction)theEObject;
				T result = caseGenericFunction(genericFunction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GenericPackage.GENERIC_STEP: {
				GenericStep genericStep = (GenericStep)theEObject;
				T result = caseGenericStep(genericStep);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GenericPackage.GENERIC_INPUT: {
				GenericInput genericInput = (GenericInput)theEObject;
				T result = caseGenericInput(genericInput);
				if (result == null) result = caseGenericStep(genericInput);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GenericPackage.GENERIC_OUTPUT: {
				GenericOutput genericOutput = (GenericOutput)theEObject;
				T result = caseGenericOutput(genericOutput);
				if (result == null) result = caseGenericStep(genericOutput);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseGenericInput(GenericInput object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseGenericOutput(GenericOutput object) {
		return null;
	}
